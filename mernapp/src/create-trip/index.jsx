  ...
  selectProps={{
    ...
    styles: {
      option: (provided, state) => ({
        ...provided,
        backgroundColor: state.isFocused ? '#2dd4bf' : '#ffffff', // Highlight when hovered
        color: '#000000', // Text color
      }),
      menu: (provided) => ({
        ...provided,
        backgroundColor: '#ffffff', // Menu dropdown background
      }),
      control: (provided) => ({
        ...provided,
      ...
      input: (provided) => ({
        ...provided,
        color: '#000000', // User typing text color
      }),
    },
  }}
/>
            ...
            <p className="text-gray-400 text-sm">Loading Google Places...</p>
          )}
        </div>
